...
const PROPIAS = ['variantes', 'brecha', 'creador', 'gerencia', 'cliente', 'senal', 'gpshttp', 'foto', 'marca', 'respaldo',
                 'trazador', 'hud', 'chat', 'cola', 'margenes', 'gestos', 'imagen', 'tema', 'mapa', 'teclado', 'nativas'];
