...
| 3.5 | **Perfil del conductor en la app** | Pedido el 7/8. Una pantalla propia del chofer: quién es (nombre, alias), en qué unidad y ruta está, la marca de su cooperativa, y lo suyo del período — horas y vueltas, que hoy solo ve el gerente. Alcance fino a definir con el dueño (¿cambio de contraseña? ¿editar el alias?): todo lo que muestre ya existe en el servidor, así que el grueso es pantalla y un endpoint de lectura con el borde bien puesto — el chofer ve LO SUYO, nada de la ruta de al lado | medio día — 1 día |
