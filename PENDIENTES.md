...
| --- | --- | --- | --- |
| 1 | **Rutas alternas** | Es el cambio de esquema que queda, y el esquema es lo único que se encarece con el uso. Los desvíos programados (una obra de tres meses) no se resuelven silenciando: el trazado cambió | 2–3 días |
| 2 | **Cumplimiento de brecha** | El único número que la cooperativa querría y todavía no existe: cuánto tiempo estuvo cada unidad en verde, ámbar y rojo. Hace falta guardarlo, no se puede reconstruir — pero mientras nadie use la app no se está perdiendo nada | 1 día |
| 3 | **Panel del gerente de ruta** | Vive de los informes, que ya existen. Es el que más se beneficia de esperar: hoy estaríamos adivinando qué mira un gerente | 2 días |

Mover tablas con seis meses de datos adentro es una migración con riesgo, y
hoy no lo es. Por eso el ítem de esquema va primero; el resto se suma encima
y cuesta lo mismo después.
...
- **Se diseña desde el panel del creador**, no desde Despacho: es
...
trazado real coincide con lo que dibujemos. Con el ítem 1 hecho hay algo que
se puede poner en dos o tres unidades una semana, y esa semana va a reordenar
esta lista mejor que nosotros.
